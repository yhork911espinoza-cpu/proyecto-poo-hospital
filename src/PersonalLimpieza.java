...
public class PersonalLimpieza extends PersonalHospital {
    ...
    public PersonalLimpieza(String areaAsignada, String nombre, String primerApellido, String segundoApellido, String contraseña, int dni, String direccion, String telefono, String email, LocalDate fechaNacimiento, String genero, String turno) {
