...
public class GuardiaSeguridad extends PersonalHospital {
    ...
    public boolean actualizarNombre(int dni, String nuevoNombre) {
        String sql = "UPDATE GuardiasSeguridad SET nombre = ? WHERE dni = ?";
    ...
    public boolean actualizarPrimerApellido(int dni, String nuevoApellido) {
        String sql = "UPDATE GuardiasSeguridad SET primerApellido = ? WHERE dni = ?";
        try (Connection con = ConexionSQL.getConexion();
                PreparedStatement ps = con.prepareStatement(sql)) {
            if (con == null)
                return false;
    ...
    public boolean actualizarSegundoApellido(int dni, String nuevoApellido) {
        String sql = "UPDATE GuardiasSeguridad SET segundoApellido = ? WHERE dni = ?";
        try (Connection con = ConexionSQL.getConexion();
                PreparedStatement ps = con.prepareStatement(sql)) {
            if (con == null)
                return false;
    ...
    public boolean actualizarDireccion(int dni, String nuevaDireccion) {
        String sql = "UPDATE GuardiasSeguridad SET direccion = ? WHERE dni = ?";
        try (Connection con = ConexionSQL.getConexion();
                PreparedStatement ps = con.prepareStatement(sql)) {
            if (con == null)
                return false;
    ...
    public boolean actualizarTelefono(int dni, String nuevoTelefono) {
        String sql = "UPDATE GuardiasSeguridad SET telefono = ? WHERE dni = ?";
        try (Connection con = ConexionSQL.getConexion();
                PreparedStatement ps = con.prepareStatement(sql)) {
            if (con == null)
                return false;
    ...
    public boolean actualizarEmail(int dni, String nuevoEmail) {
        String sql = "UPDATE GuardiasSeguridad SET email = ? WHERE dni = ?";
        try (Connection con = ConexionSQL.getConexion();
                PreparedStatement ps = con.prepareStatement(sql)) {
            if (con == null)
                return false;
    ...
    public boolean actualizarAreaAsignada(int dni, String nuevaArea) {
        String sql = "UPDATE GuardiasSeguridad SET areaAsignada = ? WHERE dni = ?";
        try (Connection con = ConexionSQL.getConexion();
                PreparedStatement ps = con.prepareStatement(sql)) {
            if (con == null)
                return false;
    ...
    // ACTUALIZAR TURNO
    // ================================
    public boolean actualizarTurno(int dni, String turno) {
        String sql = "UPDATE GuardiasSeguridad SET turno = ? WHERE dni = ?";
        try (Connection con = ConexionSQL.getConexion();
                PreparedStatement ps = con.prepareStatement(sql)) {
            if (con == null)
                return false;
    ...
    public boolean actualizarContrasena(int dni, String nuevaContrasena) {
        String sql = "UPDATE GuardiasSeguridad SET contraseña = ? WHERE dni = ?";
        try (Connection con = ConexionSQL.getConexion();
                PreparedStatement ps = con.prepareStatement(sql)) {
            if (con == null)
                return false;
    ...
    public boolean eliminarPorDni(int dni) {
        String sql = "DELETE FROM GuardiasSeguridad WHERE dni = ?";
        try (Connection con = ConexionSQL.getConexion();
                PreparedStatement ps = con.prepareStatement(sql)) {
            ps.setInt(1, dni);
            return ps.executeUpdate() > 0;
